                ...
                <div class="col-lg-11" >
                        <div class="card card-outline-info"  style="background-color:#999;color:#FFF">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Rights </h4>
                            </div>
...
if (mysqli_num_rows($result) > 0) 
{
	...
	{
                                                ?>
                                                <option  value="<?php echo $row["eid"];?>"><?php echo $row["emp_name"];?></option>
                                                <?php
	}
}?>
...
<option value="hr">Give HR Rights</option>
<option value="hod">Give Hod Rights</option>

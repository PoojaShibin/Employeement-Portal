...
{ ?>
<li class="nav-label"><a href="data.php">Attendance</a></li>         <li class="nav-label"><a href="wish.php?tto=&job=">Birthday Wish</a></li>                <li class="nav-label"><a href="leave.php">Apply Leave</a></li>
                        <li class="nav-label"><a href="empdata.php">View Leave Status</a></li>
                        <li class="nav-label"><a href="profile.php">My profile</a></li>
                          <li class="nav-label"><a href="login.php?job=2">Logout</a></li>
                       <?php }
...
if (mysqli_num_rows($result) > 0) 
{
	...
	{?>
                                               ...
                                               <option value="<?php $m= $row["dept_id"];echo $m;?>" ><?php echo $row["dept_name"];?></option>
                                               <?php
}
}?>

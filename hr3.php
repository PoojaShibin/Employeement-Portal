...
else
{
	...
	$sql = "SELECT * FROM  leave_detail   lv  inner join emp_detail emp on  lv.emp_id=emp.eid inner join dept_detail dept on emp.dept_id=dept.dept_id  and lv.hod=1  and lv.hr=0 where lv.ll_id='$s'";

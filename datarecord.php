...
if (mysqli_num_rows($result) > 0) 
{
	...
	{?>
                                               ...
                                               <option value="<?php $m= $row["emp_code"];echo $m;?>" <?php  if ($m == $code) echo "selected='selected'";?>><?php echo $row["emp_name"];?></option>
                                               <?php
}
}?>
                                                </select></td>
...
<div class="card-body">
                                <div class="table-responsive m-t-50">
                                     <table id="dvData" class="display  table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
        <tr>

...
include 'connection.php';
	...
	$sql="INSERT INTO `emp_detail`( `emp_code`, `emp_name`, `dept_id`, `emp_designation`, `emp_off`, `s_grade`,  `password`, `image`, `joindate`, `dob`, `phone`, `email`) VALUES ('$a','$b','$c','$d','$h','$g','$i','$img','$f','$e','$j','$k')";

...
$code=$row["emp_code"];
	...
	if($url=="")
	{
		$url='/var/www/html/images/faces/empty.png';
	}
...
<?php
$sql = "SELECT * FROM emp_detail where emp_del=0";
$result = mysqli_query($con, $sql);
...
if (mysqli_num_rows($result) > 0) 
{
	...
	{?>
                                                ...
                                                <option value="<?php echo $row["emp_code"];?>" <?php if ($e == $row["dept_id"]) echo "selected='selected'";?>><?php echo $row["emp_name"];?></option>
                                               <?php
}
}?>
                                                </select></td>
...
$tyear=date('Y');
//////////////////////////////////////////////////////api code/////////////////////////////////
$maps_url='http://192.168.25.2/employee/api/employee?paycode='.$code.'&month='.$tmonth.'&year='.$tyear.'';
  ...
  <tbody>
                                            ...
                                            <tr>
                                               ...
                                               <td style="color:#000"> <?php echo $b;?></td>
                                                ...
                                                <td style="color:#000"> <?php echo $tmonth;?></td>
                                               <td style="color:#000"> <?php echo $tyear;?></td>
                                            </tr>
                                        </tbody>

            ...
            <div class="container">
                <div class="banner_text_inner">
                    ...
                    <ul>
                        ...
                        <li><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i>Urgent mails</a></li>
                    </ul>
                </div>
            </div>
        </section>
                ...
                <div class="static_inner">
                    <div class="row">
                        <div class="col-lg-9">
                            ...
                            <center><h3>Urgent Mails</h3></center><br />
                            <?php $q=$_REQUEST['t'];?>
                            <form action="regsolve.php?job=5&t=<?php echo $q;?>" method="post">
                            <table>
                            <tr><td><h3>Please Select to whom you want to send the mail</h3></td></tr>
                            <tr><td>&nbsp;</td></tr>
                           
                            <tr ><td><input type="checkbox" name="t1[]" value="Kishore.Karmakar@ibc24.in"/><b>Kishore Karmakar Sir</b></td></tr>
                            <tr ><td><input type="checkbox" name="t1[]" value="Ajay.Verma@ibc24.in"/><b>Ajay Verma Sir</b></td></tr>
                             <tr><td>&nbsp;</td></tr>
                            <tr><td><input type="submit" class="btn btn-danger" style="padding:5px 5px 5px 5px"/></td></tr>
                         </table>

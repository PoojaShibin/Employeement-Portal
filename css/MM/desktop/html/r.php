                        ...
                        <div class="card">
                            <div class="card-body">
                               ...
                               <form action="r.php" method="post" style="height:70px; ">
                                <td><label>Select Leave Tpype</label></td>
                        ...
                        <div class="card">
                            <div class="card-body">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
										...
										$from=$_POST['from'];
										$to=$_POST['to'];
$sql = "SELECT * FROM leave_detail lv inner join emp_detail emp on lv.emp_id=emp.eid inner join dept_detail dept on emp.dept_id= dept.dept_id and lv.hod=1 and lv.hr=1 and ((lv.leave_type='$drop' and lv.leave_from<='$from' and lv.leave_to >= '$to') or (lv.leave_type='$drop' and lv.leave_from>='$from' and lv.leave_to<='$to') )";
$result = mysqli_query($con, $sql);

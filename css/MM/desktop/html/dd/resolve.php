            ...
            <div class="container">
                <div class="banner_text_inner">
                    ...
                    <ul>
                        ...
                        <li><a href="resolve.php"><i class="fa fa-angle-right" aria-hidden="true"></i>Ticket Close</a></li>
                    </ul>
                </div>
            </div>
        </section>
...
<br />
  ...
  <div class="container">
    <h3 style="color:#F00">Ticket Close</h3>
  </div><br />
...
<?php
  ...
  <div class="container">
   <center> <a href="tkt.php?job=2 && tkt=<?php echo $a;?>" class="btn btn-danger" style="padding:15px 35px 15px 45px;">Ticket Close</a></center>
  </div><br />
<br />

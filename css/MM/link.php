            ...
            <div class="container">
                <div class="banner_text_inner">
                    ...
                    <ul>
                        ...
                        <li><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i>Link Page</a></li>
                    </ul>
                </div>
            </div>
        </section>
                ...
                <div class="static_inner">
                    <div class="row">
                        <div class="col-lg-9">
                            ...
                            <center><h3>Useful Links</h3></center><br />
  <?php 
  $a="";
...
if (mysqli_num_rows($result) > 0) 
{
   $count=0;
	...
	?><table style="width:auto;" border="0"><tr><?php 
  ...
  <img class="card-img-top" src="<?php echo $row["img"];?>" alt="Card image cap" width="250" height="250">
  <div class="card-body">
    <h5 class="card-title"><?php echo $row["name"];?></h5>
   
    <a href="<?php echo $row["link"];?>" class="btn btn-primary">Click Me..</a>
  </div>
</div></td>

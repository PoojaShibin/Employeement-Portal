...
<html lang="en">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    ...
    <body>
        ...
        <a href="other.php" class="btn btn-warning pull-right" style="position:fixed;">Other Contacts</a> 
            <div class="container">
                <div class="static_inner">
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="static_main_content">
                            <center><h3>Employee Contacts</h3></center><br>
...
{
?>
   <tr align="center" style="padding:10px 10px 10px 10px;" >
                            <td ><?php echo $row['eid'];?></td>
                            <td><?php echo $row['name'];?></td>
                            <td ><?php echo $row['department'];?></td>
                            <td><?php echo $row['designation'];?></td>

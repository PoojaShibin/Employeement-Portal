        ...
        <div   class="page-wrapper"  style="background-color:#39F">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    ...
                    <h3 class="text-primary">Update Employee record </h3> </div>
            ...
            <div  class="container-fluid">
              ...
              <div  class="card">
				...
				if($j=="")
				{
                  ...
                  <!--================================================================1st part=================================================-->
                 <form class="form-sample" action="hrup.php"  method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control"  name="soff" value="" required>
                          </div>
                        </div>
                      </div>
                    </div><br>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                             <input class="form-control" type="tel" value="" name="phone" id="example-tel-input" required>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                             <input type="email" class="form-control" id="exampleInputEmail1" name="mail" aria-describedby="emailHelp"  value=""  required>
                          </div>
                          </div>
                          </div>
                          </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="offset-sm-3 col-md-9">
                                                      <input  type="submit" value="Update " style="width:350px;"type="button" class="btn btn-success" />
				...
				{
					$sql = "SELECT * FROM emp_detail where eid=$j";
$result = mysqli_query($con, $sql);
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                           <label class="col-sm-3 col-form-label">Employee Code</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control"  name="code"value="<?php echo $row["emp_code"];?>" required>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <select class="form-control" id="val-skill" name="dept">
                                                    <option value="">Please select Department</option>
                                                    <option value="6" <?php $dept= $row["dept_id"]; if ($dept == '6') echo "selected='selected'";?>>HR</option>
                                                    <option value="7" <?php $dept= $row["dept_id"]; if ($dept == '7') echo "selected='selected'";?>>HOD</option>
                                                    <option value="1" <?php $dept= $row["dept_id"]; if ($dept == '1') echo "selected='selected'";?>>IT Department</option>
                                                    <option value="2" <?php $dept= $row["dept_id"]; if ($dept == '2') echo "selected='selected'";?>>Print Media</option>
                                                    <option value="3" <?php $dept= $row["dept_id"]; if ($dept == '3') echo "selected='selected'";?>>Media Monitoring</option>
                                                    <option value="5" <?php $dept= $row["dept_id"]; if ($dept == '5') echo "selected='selected'";?>>Social Media</option>
                                                    <option value="4" <?php $dept= $row["dept_id"]; if ($dept == '4') echo "selected='selected'";?>>Reception</option>
                                                    <option value="8" <?php $dept= $row["dept_id"]; if ($dept == '8') echo "selected='selected'";?>>Admin</option>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <select class="form-control" id="val-skill" name="shift">
                                                    <option value="">Please select Shift Time</option>
                                                    <option value="A" <?php $shift= $row["s_grade"]; if ($shift == 'A') echo "selected='selected'";?>>6:00-3:00</option>
                                                    <option value="B" <?php $shift= $row["s_grade"]; if ($shift == 'B') echo "selected='selected'";?>>3:00-12:00</option>
                                                    <option value="C" <?php $shift= $row["s_grade"]; if ($shift == 'C') echo "selected='selected'";?>>10:00-7:00</option>
                                                </select>
                          </div>
                        </div>
                      </div>

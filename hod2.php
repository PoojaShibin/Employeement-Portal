                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card" >
						 ...
						 /// table part starts
	$sql = "SELECT * FROM  leave_detail   lv  inner join emp_detail emp on  lv.emp_id=emp.eid inner join dept_detail dept on emp.dept_id=dept.dept_id  and lv.hod=0  and lv.hr=0 order by lv.emp_id desc";
$result = mysqli_query($con, $sql);

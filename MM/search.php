...
<!-- <button id="exportButton" class="btn btn-sm btn-warning clearfix"><span class="fa fa-file-excel-o"></span> Export to Excel</button><br>-->
  <div class="table-responsive">  
                            <table width="100%" class="table table-bordered" id="myTable">
                            <tr>
                <th>Sno</th>
		...
		if($z%2==0)
{
		...
		{?>
                            <td ><?php echo "Yes";?></td>
                            <?php
		}else{ ?>  <td ><span style="background-color:#F00;color:#FFF; font-weight:bolder;padding:10px 10px 10px 10px"><?php echo "No";?></span></td>
                            <?php
		}?>
                            <?php
							if($row['tkt_close']=='1')

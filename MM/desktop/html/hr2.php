                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card" >
						 ...
						 /// table part starts
	$sql = "SELECT * FROM  leave_detail   lv  inner join emp_detail emp on  lv.emp_id=emp.eid inner join dept_detail dept on emp.dept_id=dept.dept_id  and (lv.hod=0 or lv.hod=1 ) and lv.hr=0 order by lv.leave_id desc ";
$result = mysqli_query($con, $sql);
...
?>
        ...
        <td style="color:#000"><?php echo $j;?></td>
         ...
         <td style="color:#000"><?php echo date("d-m-Y", strtotime($lstart)); ?></td>
         <td style="color:#000"><?php echo date("d-m-Y", strtotime($lend));?></td>
        ...
        ?>
        <td style="color:#000"><a class="btn disabled" href="#" style="padding:5px 10px 5px 10px"  disabled>Approved</a></td>
          <td style="color:#000"><a class="btn disabled" href="#" style="padding:5px 5px 5px 5px" disabled>Disapprove</a></td>
          <td style="color:#000">  H O D </td></tr>
          <?php
		 ...
		 <td style="color:#000"><a href="hr3.php?job=a && lv=<?php echo $lid;?>"  class="btn btn-success"style="padding:5px 10px 5px 10px" >Approved</a></td>
          <td style="color:#000"><a href="hr3.php?job=b && lv=<?php echo $lid;?>" class="btn btn-success"style="padding:5px 5px 5px 5px" >Disapprove</a></td>
          <td style="color:#000">  H R </td></tr>
          <?php
		 }

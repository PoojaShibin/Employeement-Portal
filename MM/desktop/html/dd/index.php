    ...
    <body>
        ...
        <header class="main_menu_area">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <b><a class="navbar-brand" href="#"><p style="color:#FFF;font-size:3vw">Media Monitoring</p></a></b>
                    ...
                    <!-- MAIN IMAGE -->
                        ...
                        <div class="slider_text_box">
                            ...
                            <div class="tp-caption tp-resizeme secand_text"
                                ...
                                style="z-index: 8;font-family:'Poppins', sans-serif;font-weight:700;color:#F0F;background-color:rgba(12, 11, 11, 0.32);"> Media Monitoring<br/> Welcomes You
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="c_box_item">
                                <a href="#"><h4><i class="fa fa-diamond" aria-hidden="true"></i> Links</h4></a>
                                <p>You Are Provided With Variouse Links Which You Can Easily Access From Here With No Efforts<br><br>
<a href="/var/www/html/dd/link.php" class="btn-success" style="padding:10px 10px 10px 10px">Click me</a></p>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="c_box_item">
                                <a href="#"><h4><i class="fa fa-diamond" aria-hidden="true"></i> Employee Contacts</h4></a>
                                <p>You Are Provided With All Employee Contacts So That In Case Of Help You Can Contact Them<br><br>
<a href="/var/www/html/dd/emp.php" class="btn-success" style="padding:10px 10px 10px 10px">Click me</a></p>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="c_box_item">
                                <a href="#"><h4><i class="fa fa-diamond" aria-hidden="true"></i>Register Complaints</h4></a>
                               <p>Please Register Your ComplaintsOver here and generator your token number.<br>
 <br><br>
<a href="reg.php?job=" class="btn-success" style="padding:10px 10px 10px 10px">Click me</a></p>
                            </div>
                        </div>
                    </div>
                </div>

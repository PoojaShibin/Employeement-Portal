...
<a href="link.php" class="btn-success" style="padding:10px 10px 10px 10px">Click me</a></p>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="c_box_item">
...
<a href="emp.php" class="btn-success" style="padding:10px 10px 10px 10px">Click me</a></p>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="c_box_item">
